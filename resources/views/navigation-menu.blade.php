            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{--
                            ...
                            <x-slot name="content">
                                <div class="w-60">
                                    <x-dropdown-link href="{{ route('price') }}"
                                        class="dropdown-item
                                    {{ request()->routeIs('price') ? 'active' : '' }}
                                    ">
                                        Pricing Plan
                                    </x-dropdown-link>
                                    <x-dropdown-link href="{{ route('feature') }}"
                                        class="dropdown-item
                                    {{ request()->routeIs('feature') ? 'active' : '' }}
                                    ">
                                        Our features
                                    </x-dropdown-link>
                                    <x-dropdown-link href="{{ route('mhr-dev-team') }}"
                                        class="dropdown-item
                                    {{ request()->routeIs('mhr-dev-team') ? 'active' : '' }}
                                    ">
                                        Team Members
                                    </x-dropdown-link>
                                    <x-dropdown-link href="{{ route('testimonial') }}"
                                        class="dropdown-item
                                    {{ request()->routeIs('testimonial') ? 'active' : '' }}
                                    ">
                                        Testimonial
                                    </x-dropdown-link>
                                    <x-dropdown-link href="{{ route('quote') }}"
                                        class="dropdown-item
                                    ...
                                    <div class="w-60">
                                        ...
                                        @if (Auth::user()->allTeams()->count() > 1)
                                            ...
                                            @foreach (Auth::user()->allTeams() as $team)
                                                <x-switchable-nav-team :team="$team" />
                                            @endforeach
                                        @endif
                                    </div>
                                </x-slot>
